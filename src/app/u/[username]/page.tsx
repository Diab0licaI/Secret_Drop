...
export default function SendMessage() {
  ...
  return (
    <div className="min-h-screen bg-[#0f172a] py-8 px-4">
      <div className="container mx-auto p-6 md:p-8 bg-white rounded-xl shadow-xl max-w-4xl">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex justify-center">
              {isLoading ? (
                <Button disabled className="bg-[#0f172a] text-white">
        ...
        <div className="space-y-4 my-8">
          <div className="space-y-2">
            <Button
              ...
              className="my-4 bg-[#0f172a] hover:bg-[#1e293b] text-white"
